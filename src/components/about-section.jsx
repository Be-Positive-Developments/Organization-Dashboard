    ...
    <section id="about" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          <h2 className="text-5xl font-bold mb-6 text-gray-900">{t('about.title')}</h2>
          ...
          {strengths.map((strength, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-gradient-to-br ${strength.gradient} p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300`}>
                ...
                <h3 className="text-2xl font-bold mb-3 text-gray-900">{t(strength.titleKey)}</h3>
                <p className="text-gray-700 leading-relaxed">{t(strength.descKey)}</p>
              </motion.div>);
