...
export function IdeaSection() {
  ...
  return (
    <section id="idea" className="py-24 bg-gradient-to-br from-red-50 via-white to-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          <h2 className="text-5xl font-bold mb-6 text-gray-900">{t('idea.title')}</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <motion.div
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl">
              <h3 className="text-3xl font-bold mb-4 text-gray-900">{t('idea.problem.title')}</h3>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-start gap-4 bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div>
                    <h4 className="text-xl font-bold mb-2 text-gray-900">{t(feature.titleKey)}</h4>
