...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-24 bg-gradient-to-br from-gray-50 via-red-50 to-white">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          <h2 className="text-5xl font-bold mb-6 text-gray-900">{t('features.title')}</h2>
            ...
            return (
              <motion.div
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">{t(feature.titleKey)}</h3>
